...
To install plugin just copy archive contents to your "steamapps\%yoursteamusername%\team fortress 2\tf\addons" folder.
Create "addons" folder if it doesn't exist.

Edit PREC.cfg to change plugin's sounds, phrase and settings.
...
Thanks to Casual, for VMT update.